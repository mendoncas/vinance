defmodule LifinanceWeb.RevenueLiveTest do
  use LifinanceWeb.ConnCase

  import Phoenix.LiveViewTest
  import Lifinance.ReceiptsFixtures

  @create_attrs %{date: "some date", username: "some username", value: 120.5}
